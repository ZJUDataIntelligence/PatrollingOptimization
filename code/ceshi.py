...
#print temp
target_id_states = env.target_grids + temp.tolist()#有效node的两倍长度数组，比如点为0,1,2,3,4,5，1无效，则该数组为(0,2,3,4,5,6,8,9,10,11)
...
for n_iter in np.arange(25):
    ...
    #print curr_s
    normalized_curr_s = stateprocessor.utility_normalize_states(curr_s)#curr_s归一化，所有driver数量/最大的driver数量，所有order数/最大的order数
