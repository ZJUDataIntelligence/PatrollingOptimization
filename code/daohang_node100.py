...
origin_distance = np.load('100distance.npy')
origin_crime = np.load('100crime.npy')
...
for n_iter in np.arange(180):
    ...
    action_step = 9000  # 总移动步长
    now_step = action_step
    greedy_coverage_step = action_step
    now_greedy_coverage_step = greedy_coverage_step
    greedy_reward_step = action_step
